...
const translations = {
    pt: {
        ...
        nb_scheduling_title: "Agendamento de Postagem (Opcional)",
        nb_start_date: "Data/Hora de Início",
        nb_interval: "Intervalo entre Pins",
        nb_interval_none: "Sem agendamento (publicar imediatamente)",
        nb_interval_30m: "A cada 30 minutos",
        nb_interval_1h: "A cada 1 hora",
        nb_interval_2h: "A cada 2 horas",
        nb_interval_3h: "A cada 3 horas",
        nb_interval_6h: "A cada 6 horas",
        nb_interval_12h: "A cada 12 horas",
        nb_interval_24h: "A cada 24 horas (1 vez por dia)",
        nb_utm_tracking: "Rastreamento UTM Automático",
        nb_utm_tracking_help: "Adiciona parâmetros UTM para contornar a regra de link duplicado do Pinterest e permitir rastreio no Google Analytics.",
        ...
        hist_btn_view: "Ver Pins",
        hist_btn_reuse: "Reutilizar Lote",
        hist_btn_download_zip: "Baixar Imagens (ZIP)",
        hist_modal_view_title: "Detalhes do Lote",
        hist_modal_pins_list: "Pins Gerados",
        hist_modal_no_pins: "Nenhum detalhe de pin salvo para este lote (lote antigo).",
    ...
    en: {
        ...
        nb_scheduling_title: "Pin Scheduling (Optional)",
        nb_start_date: "Start Date/Time",
        nb_interval: "Interval Between Pins",
        nb_interval_none: "No scheduling (publish immediately)",
        nb_interval_30m: "Every 30 minutes",
        nb_interval_1h: "Every 1 hour",
        nb_interval_2h: "Every 2 hours",
        nb_interval_3h: "Every 3 hours",
        nb_interval_6h: "Every 6 hours",
        nb_interval_12h: "Every 12 hours",
        nb_interval_24h: "Every 24 hours (1 time per day)",
        nb_utm_tracking: "Automatic UTM Tracking",
        nb_utm_tracking_help: "Adds UTM parameters to bypass Pinterest's duplicate link rules and enable tracking in Google Analytics.",
        ...
        hist_btn_view: "View Pins",
        hist_btn_reuse: "Reuse Batch",
        hist_btn_download_zip: "Download Images (ZIP)",
        hist_modal_view_title: "Batch Details",
        hist_modal_pins_list: "Generated Pins",
        hist_modal_no_pins: "No pin details saved for this batch (older batch).",
    ...
    es: {
        ...
        nb_scheduling_title: "Programación de Pines (Opcional)",
        nb_start_date: "Fecha/Hora de Inicio",
        nb_interval: "Intervalo entre Pines",
        nb_interval_none: "Sin programación (publicar de inmediato)",
        nb_interval_30m: "Cada 30 minutos",
        nb_interval_1h: "Cada 1 hora",
        nb_interval_2h: "Cada 2 horas",
        nb_interval_3h: "Cada 3 horas",
        nb_interval_6h: "Cada 6 horas",
        nb_interval_12h: "Cada 12 horas",
        nb_interval_24h: "Cada 24 horas (1 vez por día)",
        nb_utm_tracking: "Seguimiento UTM Automático",
        nb_utm_tracking_help: "Agrega parámetros UTM para evitar la regla de enlaces duplicados de Pinterest y habilitar el seguimiento en Google Analytics.",
        ...
        hist_btn_view: "Ver Pines",
        hist_btn_reuse: "Reutilizar Lote",
        hist_btn_download_zip: "Descargar Imágenes (ZIP)",
        hist_modal_view_title: "Detalles del Lote",
        hist_modal_pins_list: "Pines Generados",
        hist_modal_no_pins: "No se guardaron detalles de pines para este lote (lote antiguo).",
